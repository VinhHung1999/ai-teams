...
- [x] **[381]** Slash dropdown scroll + all scrollable lists audit
      **Priority:** P0 · **Points:** 1 · **Assignee:** DEV · **Status:** done · **Backlog-ID:** 413
      **Notes:**
      2026-05-03 DEV: ChatInput slash dropdown: inner scroll wrapper maxHeight=240px + overflow-y:auto + WebkitOverflowScrolling:touch (41 skills now scroll). AgentsTab: height=100%+overflow-y:auto. TeamList+OverviewTab already had chat-scroll. Commit pending.
